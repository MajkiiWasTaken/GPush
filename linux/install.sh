...
# Preserve an existing v4 config.
# Otherwise create a simple portable config.
...
# Ensure ~/.local/bin is available in common shells
...
# Force a fresh cache after upgrades,
# then run a lightweight sanity check.
